  ...
  return (
    <ScrollView style={styles.container}>
      <View style={styles.introView}>
        ...
        />
        <Text style={styles.projectName}>{PROJECTS_DATA[id].projectName}</Text>
      </View>
      ...
      <View style={styles.infoView}>
        ...
        <ScrollView style={styles.ssView} horizontal={true}>
          {PROJECTS_DATA[id].ssURL.map((each, id) => (
            ...
            //modal implementation to view enlarged ss here
          ))}
        </ScrollView>
        ...
        {PROJECTS_DATA[id].futureScope.status ? (
          <>
            ...
            <ProjectsCard
              ...
              iconURL={PROJECTS_DATA[PROJECTS_DATA[id].futureScope.id].iconURL}
              langUsed={
